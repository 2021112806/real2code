...
for SPLIT in train test; do
    python shape_complete/datagen.py --data_dir /mnt/data/zhangzhaodong/real2code/datasets/output/ --obj_type $OBJ --out_dir /mnt/data/zhangzhaodong/real2code/shape_output/ --vis_dir /mnt/data/zhangzhaodong/real2code/shape_output/vis --split $SPLIT
done